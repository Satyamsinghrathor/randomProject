...
export default function Student() {
  ...
  const handleSearch = () => {
    ...
    navigate(`/student/${rollNo}`);// simulate fetch
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl shadow-black/50">
          ...
          <button
            ...
            className={`mt-5 w-full flex items-center justify-center gap-2 rounded-xl py-3 px-4 text-sm font-semibold tracking-wide transition-all duration-200
              ${rollNo.trim() && !loading
        ...
        {/* Footer note */}
        <p className="text-center text-slate-700 text-xs mt-5 font-mono">
